...
Original file is located at
    https://colab.research.google.com/drive/1WPicz4Y8T-NsPRMjeKHc19O88fcszMtp
"""
...
# ---------------------------------------------------
# BIOGAS EMISSION FACTORS (FIXED, LITERATURE-AVERAGED)
# ---------------------------------------------------

# ---- CHANGE 1: literature-based EF ranges (kg pollutant per ton biogas) ----
biogas_EF_literature = {
    "TSP":   [0.040, 0.045, 0.050, 0.055, 0.048],  # average ~0.048
    "PM10":  [0.035, 0.040, 0.045, 0.050, 0.042],  # average ~0.042
    "PM2.5": [0.015, 0.018, 0.020, 0.022, 0.017],  # average ~0.018
    "SO2":   [0.006, 0.008, 0.010, 0.012, 0.009],  # average ~0.009
    "NOx":   [0.45,  0.50,  0.55,  0.60,  0.48]    # average ~0.52
}

# ---- CHANGE 2: compute fixed EF as a mean (converted to tons/ton biogas) ----
biogas_EF = {
...
for pol in coal_baseline:
    ...
    # ---- CHANGE 3: use fixed literature-averaged biogas EF here ----
